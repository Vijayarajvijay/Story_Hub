...
import { Mystery } from "../OfflineBookis.jsx/Mystery";
import { Biographies } from "../OfflineBookis.jsx/Biography";
import { HistoricalFiction } from "../OfflineBookis.jsx/HistoricalFiction";
import { Horror } from "../OfflineBookis.jsx/Horror";
import { Romance } from "../OfflineBookis.jsx/Romance";
import { ScienceFiction } from "../OfflineBookis.jsx/ScienceFiction";
import { Thriller } from "../OfflineBookis.jsx/Thriller";
import { TrueCrime } from "../OfflineBookis.jsx/TrueCrime";
import { Travel } from "../OfflineBookis.jsx/Travel";
...
const OfflineStorysList = ({ route }) => {
  ...
  //         setStoryDetails(res.data.story)
  //       }
  //     } catch (error) {
  //       if (error.response) {
  //         Toast.show({
        ...
        {filteredGenres.length > 0 ? (
          filteredGenres.map((data, index) => (
            <TouchableOpacity
              key={index}
              onPress={() =>
                navigation.navigate("Offline Story Details", { story: data })
              }
            ...
            >
              ...
              <View style={{ flexDirection: "row" }}>
                <View style={styles.heading_Container}>
                  ...
                  <Text style={styles.genre_subtittle}>{data.createdAt}</Text>
                </View>
                <Icon
...
export default OfflineStorysList;
